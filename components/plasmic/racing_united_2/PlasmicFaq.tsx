...
import sty from "./PlasmicFaq.module.css"; // plasmic-import: MCZubOScHQegmi/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__zhOr)}
      >
        <div className={classNames(projectcss.all, sty.freeBox__o37QW)}>
          <div className={classNames(projectcss.all, sty.freeBox__zJu2Q)}>
            {p.renderPlasmicSlot({
