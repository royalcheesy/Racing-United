...
import Avatar from "../../Avatar"; // plasmic-import: SQD5u7FMzy4Rj/component
...
import sty from "./PlasmicTestimonial.module.css"; // plasmic-import: HQ-KRKWD-BLbW/css

import QuoteDashesIcon from "./icons/PlasmicIcon__QuoteDashes"; // plasmic-import: Ride7gwHV82gr1/icon
  ...
  return (
    ...
    >
      <Avatar
        ...
        pic={
          <p.PlasmicImg
            ...
            src={{
              src: "/plasmic/racing_united_2/images/profilepic.png",
              fullWidth: 192,
              fullHeight: 192,
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox___8Ousc)}
      >
        <div
          className={classNames(
            projectcss.all,
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__xkGFf)}
        >
          <div
            className={classNames(
              projectcss.all,
