...
import BaseCard from "../../BaseCard"; // plasmic-import: Ns7BOReE0trlan/component
...
import sty from "./PlasmicPlan.module.css"; // plasmic-import: lJKnMWacxDx8LT/css
...
function PlasmicPlan__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__hcqAr)}>
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__sBn1M)}
        >
          {p.renderPlasmicSlot({
          ...
          {p.renderPlasmicSlot({
            defaultContents: (
              <p.Stack
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox__fp5Ig)}
              >
                <Bullet
                  className={classNames("__wab_instance", sty.bullet__s6HXh)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet__faX0N)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet__pamzI)}
                />
              </p.Stack>
            ),
          ...
          <div className={classNames(projectcss.all, sty.freeBox__mY2Lk)}>
            {p.renderPlasmicSlot({
              defaultContents: (
                <Button
                  className={classNames("__wab_instance", sty.button__ag15N)}
